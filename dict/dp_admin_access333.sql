...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$XYO0G./2.zPgYqsCPxf7b.bstQz3eluHHTiP13MKi0WUKNH6SNbMq', '', '0', '18888888888', '0', '1', '0.00', '0', '1', '0', '0', '1476065410', '1501142992', '1501142992', '2130706433', '100', '1');
...
INSERT INTO `dp_order` VALUES ('4', '2017072755995552', '4', '6.00', '12', '1', '6.00', '0.00', '', '', '0', '2', '3', '1234', '0', '0', '0', '1501126823', '1501126823');
...
INSERT INTO `dp_user` VALUES ('2', 'pp002', 'yowe', '$2y$10$xwxlat.hQD.qNV3Rc.Y1pOViHsy086JJn//wfzlyz88wpqFWSB4Ei', '$2y$10$/sm4z2EXjsMAUSNtZDCK4uCPs.Mng0Lxzf0X3sK2V/bJiPM0cVJjS', 'de@qqq.com', '15924900002', '15924900001', '', '2', '1008.00', '0', '0', '1499827728', '1501144992', '1501144992', '2130706433', '100', '1');
...
CREATE TABLE `dp_user_account` (
  ...
  `update_time` int(11) NOT NULL COMMENT '编辑时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户资金变动表';
