...
-- ----------------------------
INSERT INTO `dp_admin_menu` VALUES ('1', '0', 'admin', '首页', 'fa fa-fw fa-home', 'module_admin', 'admin/index/index', '_self', '0', '1467617722', '1498788709', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('2', '1', 'admin', '快捷操作', 'fa fa-fw fa-folder-open-o', 'module_admin', '', '_self', '0', '1467618170', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('3', '2', 'admin', '清空缓存', 'fa fa-fw fa-trash-o', 'module_admin', 'admin/index/wipecache', '_self', '0', '1467618273', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('4', '0', 'admin', '系统', 'fa fa-fw fa-gear', 'module_admin', 'admin/system/index', '_self', '0', '1467618361', '1498788709', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('5', '4', 'admin', '系统功能', 'si si-wrench', 'module_admin', '', '_self', '0', '1467618441', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('6', '5', 'admin', '系统设置', 'fa fa-fw fa-wrench', 'module_admin', 'admin/system/index', '_self', '0', '1467618490', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('7', '5', 'admin', '配置管理', 'fa fa-fw fa-gears', 'module_admin', 'admin/config/index', '_self', '0', '1467618618', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('8', '7', 'admin', '新增', '', 'module_admin', 'admin/config/add', '_self', '0', '1467618648', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('9', '7', 'admin', '编辑', '', 'module_admin', 'admin/config/edit', '_self', '0', '1467619566', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('10', '7', 'admin', '删除', '', 'module_admin', 'admin/config/delete', '_self', '0', '1467619583', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('11', '7', 'admin', '启用', '', 'module_admin', 'admin/config/enable', '_self', '0', '1467619609', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('12', '7', 'admin', '禁用', '', 'module_admin', 'admin/config/disable', '_self', '0', '1467619637', '1499306299', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('13', '5', 'admin', '节点管理', 'fa fa-fw fa-bars', 'module_admin', 'admin/menu/index', '_self', '0', '1467619882', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('14', '13', 'admin', '新增', '', 'module_admin', 'admin/menu/add', '_self', '0', '1467619902', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('15', '13', 'admin', '编辑', '', 'module_admin', 'admin/menu/edit', '_self', '0', '1467620331', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('16', '13', 'admin', '删除', '', 'module_admin', 'admin/menu/delete', '_self', '0', '1467620363', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('17', '13', 'admin', '启用', '', 'module_admin', 'admin/menu/enable', '_self', '0', '1467620386', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('18', '13', 'admin', '禁用', '', 'module_admin', 'admin/menu/disable', '_self', '0', '1467620404', '1499306299', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('19', '68', 'user', '权限管理', 'fa fa-fw fa-key', 'module_admin', '', '_self', '0', '1467688065', '1477710702', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('20', '19', 'user', '用户管理', 'fa fa-fw fa-user', 'module_admin', 'user/index/index', '_self', '0', '1467688137', '1498716392', '1', '1', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('211', '64', 'admin', '日志详情', '', 'module_admin', 'admin/log/details', '_self', '0', '1480299320', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('32', '4', 'admin', '扩展中心', 'si si-social-dropbox', 'module_admin', '', '_self', '0', '1467688853', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('33', '32', 'admin', '模块管理', 'fa fa-fw fa-th-large', 'module_admin', 'admin/module/index', '_self', '0', '1467689008', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('34', '33', 'admin', '导入', '', 'module_admin', 'admin/module/import', '_self', '0', '1467689153', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('35', '33', 'admin', '导出', '', 'module_admin', 'admin/module/export', '_self', '0', '1467689173', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('36', '33', 'admin', '安装', '', 'module_admin', 'admin/module/install', '_self', '0', '1467689192', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('37', '33', 'admin', '卸载', '', 'module_admin', 'admin/module/uninstall', '_self', '0', '1467689241', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('38', '33', 'admin', '启用', '', 'module_admin', 'admin/module/enable', '_self', '0', '1467689294', '1499306299', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('39', '33', 'admin', '禁用', '', 'module_admin', 'admin/module/disable', '_self', '0', '1467689312', '1499306299', '6', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('40', '33', 'admin', '更新', '', 'module_admin', 'admin/module/update', '_self', '0', '1467689341', '1499306299', '7', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('41', '32', 'admin', '插件管理', 'fa fa-fw fa-puzzle-piece', 'module_admin', 'admin/plugin/index', '_self', '0', '1467689527', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('42', '41', 'admin', '导入', '', 'module_admin', 'admin/plugin/import', '_self', '0', '1467689650', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('43', '41', 'admin', '导出', '', 'module_admin', 'admin/plugin/export', '_self', '0', '1467689665', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('44', '41', 'admin', '安装', '', 'module_admin', 'admin/plugin/install', '_self', '0', '1467689680', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('45', '41', 'admin', '卸载', '', 'module_admin', 'admin/plugin/uninstall', '_self', '0', '1467689700', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('46', '41', 'admin', '启用', '', 'module_admin', 'admin/plugin/enable', '_self', '0', '1467689730', '1499306299', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('47', '41', 'admin', '禁用', '', 'module_admin', 'admin/plugin/disable', '_self', '0', '1467689747', '1499306299', '6', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('48', '41', 'admin', '设置', '', 'module_admin', 'admin/plugin/config', '_self', '0', '1467689789', '1499306299', '7', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('49', '41', 'admin', '管理', '', 'module_admin', 'admin/plugin/manage', '_self', '0', '1467689846', '1499306299', '8', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('50', '5', 'admin', '附件管理', 'fa fa-fw fa-cloud-upload', 'module_admin', 'admin/attachment/index', '_self', '0', '1467690161', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('51', '70', 'admin', '文件上传', '', 'module_admin', 'admin/attachment/upload', '_self', '0', '1467690240', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('52', '50', 'admin', '下载', '', 'module_admin', 'admin/attachment/download', '_self', '0', '1467690334', '1499306299', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('53', '50', 'admin', '启用', '', 'module_admin', 'admin/attachment/enable', '_self', '0', '1467690352', '1499306299', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('54', '50', 'admin', '禁用', '', 'module_admin', 'admin/attachment/disable', '_self', '0', '1467690369', '1499306299', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('55', '50', 'admin', '删除', '', 'module_admin', 'admin/attachment/delete', '_self', '0', '1467690396', '1499306299', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('56', '41', 'admin', '删除', '', 'module_admin', 'admin/plugin/delete', '_self', '0', '1467858065', '1499306299', '11', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('57', '41', 'admin', '编辑', '', 'module_admin', 'admin/plugin/edit', '_self', '0', '1467858092', '1499306299', '10', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('60', '41', 'admin', '新增', '', 'module_admin', 'admin/plugin/add', '_self', '0', '1467858421', '1499306299', '9', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('61', '41', 'admin', '执行', '', 'module_admin', 'admin/plugin/execute', '_self', '0', '1467879016', '1499306299', '12', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('62', '13', 'admin', '保存', '', 'module_admin', 'admin/menu/save', '_self', '0', '1468073039', '1499306299', '6', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('64', '5', 'admin', '系统日志', 'fa fa-fw fa-book', 'module_admin', 'admin/log/index', '_self', '0', '1476111944', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('65', '5', 'admin', '数据库管理', 'fa fa-fw fa-database', 'module_admin', 'admin/database/index', '_self', '0', '1476111992', '1499306299', '7', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('66', '32', 'admin', '数据包管理', 'fa fa-fw fa-database', 'module_admin', 'admin/packet/index', '_self', '0', '1476112326', '1499306299', '4', '0', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('68', '0', 'user', '管理员', 'fa fa-fw fa-user', 'module_admin', 'user/index/index', '_self', '0', '1476193348', '1498788709', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('69', '32', 'admin', '钩子管理', 'fa fa-fw fa-anchor', 'module_admin', 'admin/hook/index', '_self', '0', '1476236193', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('70', '2', 'admin', '后台首页', 'fa fa-fw fa-tachometer', 'module_admin', 'admin/index/index', '_self', '0', '1476237472', '1499306299', '1', '0', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('77', '69', 'admin', '新增', '', 'module_admin', 'admin/hook/add', '_self', '0', '1476668971', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('78', '69', 'admin', '编辑', '', 'module_admin', 'admin/hook/edit', '_self', '0', '1476669006', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('79', '69', 'admin', '删除', '', 'module_admin', 'admin/hook/delete', '_self', '0', '1476669375', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('80', '69', 'admin', '启用', '', 'module_admin', 'admin/hook/enable', '_self', '0', '1476669427', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('81', '69', 'admin', '禁用', '', 'module_admin', 'admin/hook/disable', '_self', '0', '1476669564', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('183', '66', 'admin', '安装', '', 'module_admin', 'admin/packet/install', '_self', '0', '1476851362', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('184', '66', 'admin', '卸载', '', 'module_admin', 'admin/packet/uninstall', '_self', '0', '1476851382', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('185', '5', 'admin', '行为管理', 'fa fa-fw fa-bug', 'module_admin', 'admin/action/index', '_self', '0', '1476882441', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('186', '185', 'admin', '新增', '', 'module_admin', 'admin/action/add', '_self', '0', '1476884439', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('187', '185', 'admin', '编辑', '', 'module_admin', 'admin/action/edit', '_self', '0', '1476884464', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('188', '185', 'admin', '启用', '', 'module_admin', 'admin/action/enable', '_self', '0', '1476884493', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('189', '185', 'admin', '禁用', '', 'module_admin', 'admin/action/disable', '_self', '0', '1476884534', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('190', '185', 'admin', '删除', '', 'module_admin', 'admin/action/delete', '_self', '0', '1476884551', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('191', '65', 'admin', '备份数据库', '', 'module_admin', 'admin/database/export', '_self', '0', '1476972746', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('192', '65', 'admin', '还原数据库', '', 'module_admin', 'admin/database/import', '_self', '0', '1476972772', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('193', '65', 'admin', '优化表', '', 'module_admin', 'admin/database/optimize', '_self', '0', '1476972800', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('194', '65', 'admin', '修复表', '', 'module_admin', 'admin/database/repair', '_self', '0', '1476972825', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('195', '65', 'admin', '删除备份', '', 'module_admin', 'admin/database/delete', '_self', '0', '1476973457', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('210', '41', 'admin', '快速编辑', '', 'module_admin', 'admin/plugin/quickedit', '_self', '0', '1477713981', '1499306299', '13', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('209', '185', 'admin', '快速编辑', '', 'module_admin', 'admin/action/quickedit', '_self', '0', '1477713939', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('208', '7', 'admin', '快速编辑', '', 'module_admin', 'admin/config/quickedit', '_self', '0', '1477713808', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('207', '69', 'admin', '快速编辑', '', 'module_admin', 'admin/hook/quickedit', '_self', '0', '1477713770', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('212', '2', 'admin', '个人设置', 'fa fa-fw fa-user', 'module_admin', 'admin/index/profile', '_self', '0', '1489049767', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('213', '70', 'admin', '检查版本更新', '', 'module_admin', 'admin/index/checkupdate', '_self', '0', '1490588610', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('503', '499', 'admin', '新增', '', 'module_admin', 'admin/user/add', '_self', '0', '1498804339', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('499', '516', 'admin', '会员管理', 'fa fa-fw fa-user', 'module_admin', 'admin/user/index', '_self', '0', '1498789617', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('500', '517', 'admin', '商品管理', 'fa fa-fw fa-shopping-cart', 'module_admin', 'admin/product/index', '_self', '0', '1498789684', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('501', '519', 'admin', '订单管理', 'fa fa-fw fa-copy', 'module_admin', 'admin/order/index', '_self', '0', '1498789903', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('504', '499', 'admin', '编辑', '', 'module_admin', 'admin/user/edit', '_self', '0', '1498804370', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('505', '499', 'admin', '删除', '', 'module_admin', 'admin/user/delete', '_self', '0', '1498804394', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('506', '499', 'admin', '启用', '', 'module_admin', 'admin/user/enable', '_self', '0', '1498804579', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('507', '499', 'admin', '禁用', '', 'module_admin', 'admin/user/disable', '_self', '0', '1498804618', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('508', '499', 'admin', '保存', '', 'module_admin', 'admin/user/save', '_self', '0', '1498804740', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('509', '499', 'admin', '快速编辑', '', 'module_admin', 'admin/user/quickedit', '_self', '0', '1498804805', '1499306299', '7', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('510', '500', 'admin', '新增', '', 'module_admin', 'admin/product/add', '_self', '0', '1498804977', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('511', '500', 'admin', '编辑', '', 'module_admin', 'admin/product/edit', '_self', '0', '1498804995', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('512', '500', 'admin', '删除', '', 'module_admin', 'admin/product/delete', '_self', '0', '1498805047', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('513', '500', 'admin', '上架', '', 'module_admin', 'admin/product/enable', '_self', '0', '1498805097', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('514', '500', 'admin', '下架', '', 'module_admin', 'admin/product/disable', '_self', '0', '1498805140', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('515', '500', 'admin', '保存', '', 'module_admin', 'admin/product/save', '_self', '0', '1498805173', '1499306299', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('516', '1', 'admin', '会员', 'fa fa-fw fa-user-circle', 'module_admin', '', '_self', '0', '1498805729', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('517', '1', 'admin', '商品', 'fa fa-fw fa-product-hunt', 'module_admin', '', '_self', '0', '1498805964', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('518', '500', 'admin', '快速编辑', '', 'module_admin', 'admin/product/quickedit', '_self', '0', '1498806252', '1499306299', '7', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('519', '1', 'admin', '订单', 'fa fa-fw fa-reorder', 'module_admin', '', '_self', '0', '1498806649', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('520', '501', 'admin', '新增', '', 'module_admin', 'admin/order/add', '_self', '0', '1498806940', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('521', '501', 'admin', '编辑', '', 'module_admin', 'admin/order/edit', '_self', '0', '1498806966', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('522', '501', 'admin', '删除', '', 'module_admin', 'admin/order/delete', '_self', '0', '1498807031', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('523', '501', 'admin', '保存', '', 'module_admin', 'admin/order/save', '_self', '0', '1498807051', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('524', '501', 'admin', '快速编辑', '', 'module_admin', 'admin/order/quickedit', '_self', '0', '1498807086', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('525', '516', 'admin', '分销管理', 'fa fa-fw fa-sitemap', 'module_admin', 'admin/distribution/index', '_self', '0', '1498807446', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('526', '517', 'admin', '分类管理', 'fa fa-fw fa-th', 'module_admin', 'admin/cate/index', '_self', '0', '1499151946', '1499306448', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('527', '526', 'admin', '新增', '', 'module_admin', 'admin/cate/add', '_self', '0', '1499152146', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('528', '526', 'admin', '编辑', '', 'module_admin', 'admin/cate/edit', '_self', '0', '1499152231', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('529', '526', 'admin', '删除', '', 'module_admin', 'admin/cate/delete', '_self', '0', '1499152273', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('530', '526', 'admin', '保存', '', 'module_admin', 'admin/cate/save', '_self', '0', '1499152305', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('531', '526', 'admin', '快速编辑', '', 'module_admin', 'admin/cate/quickedit', '_self', '0', '1499152358', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('532', '517', 'admin', '规格管理', 'fa fa-fw fa-stack-exchange', 'module_admin', 'admin/spec/index', '_self', '0', '1499152744', '1499306467', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('533', '532', 'admin', '新增', '', 'module_admin', 'admin/spec/add', '_self', '0', '1499152810', '1499306299', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('534', '532', 'admin', '编辑', '', 'module_admin', 'admin/spec/edit', '_self', '0', '1499152845', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('535', '532', 'admin', '删除', '', 'module_admin', 'admin/spec/delete', '_self', '0', '1499152869', '1499306299', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('536', '532', 'admin', '保存', '', 'module_admin', 'admin/spec/save', '_self', '0', '1499152899', '1499306299', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('537', '532', 'admin', '快速编辑', '', 'module_admin', 'admin/spec/quickedit', '_self', '0', '1499152925', '1499306299', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('538', '517', 'admin', '品牌管理', 'fa fa-fw fa-paw', 'module_admin', 'admin/brand/index', '_self', '0', '1499306272', '1499306299', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('539', '538', 'admin', '新增', '', 'module_admin', 'admin/brand/add', '_self', '0', '1499306338', '1499306338', '100', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('540', '538', 'admin', '编辑', '', 'module_admin', 'admin/brand/edit', '_self', '0', '1499306364', '1499306364', '100', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('541', '538', 'admin', '删除', '', 'module_admin', 'admin/brand/delete', '_self', '0', '1499306382', '1499306382', '100', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('542', '538', 'admin', '保存', '', 'module_admin', 'admin/brand/save', '_self', '0', '1499306401', '1499306401', '100', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('543', '538', 'admin', '快速编辑', '', 'module_admin', 'admin/brand/quickedit', '_self', '0', '1499306420', '1499306420', '100', '0', '1');
...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$XYO0G./2.zPgYqsCPxf7b.bstQz3eluHHTiP13MKi0WUKNH6SNbMq', '', '0', '18888888888', '0', '1', '0.00', '0', '1', '0', '0', '1476065410', '1499909656', '1499909655', '2130706433', '100', '1');
...
-- ----------------------------
INSERT INTO `dp_product` VALUES ('1', '你的背包', '', '', '阿迪背包', '4', '3', '1,2,4', '24', '20', '9.00', '8.00', '7.00', '6.00', '5', '0', '1', '0', '0', '0', '0', '0', '0', '1504022400', '0.00', '100', '1', '1499405003', '1499846927');
...
INSERT INTO `dp_product` VALUES ('4', '统一老坛酸菜', '', '', '酸菜', '3', '5', '1,2,3,4,5', '22', '23', '5.00', '4.00', '3.00', '2.00', '5', '0', '4', '0', '0', '0', '0', '0', '0', '1500480000', '0.00', '100', '1', '1499652274', '1499929818');
...
-- Records of dp_user
-- ----------------------------
INSERT INTO `dp_user` VALUES ('1', 'pp001', 'alipiapia', '$2y$10$9wVp0gAP.10E.41jUNbZgu/MUBMn5XwejQRXZCE2oFYVtISMCbsLK', '', '12@qq.com', '15924900001', '15924900000', '13888888888', '0.00', '0', '0', '1499400175', '1499916277', '1499916276', '2130706433', '100', '1');
INSERT INTO `dp_user` VALUES ('2', 'pp002', 'yowe', '$2y$10$xwxlat.hQD.qNV3Rc.Y1pOViHsy086JJn//wfzlyz88wpqFWSB4Ei', '', 'de@qqq.com', '15924900002', '15924900001', '13888888888', '0.00', '0', '0', '1499827728', '1499827796', '1499827728', '2130706433', '100', '1');
...
CREATE TABLE `dp_user_address` (
  ...
  `is_defaut` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否为默认地址：0否 1是',
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态：0禁用，1启用',
  `create_time` int(11) NOT NULL COMMENT '添加时间',
  `update_time` int(11) NOT NULL COMMENT '编辑时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `dp_user_address` VALUES ('4', '1', '哇哈哈', '18489554787', '盘龙区盘龙区盘龙区盘龙区盘龙区', '', '0', '1', '1499757537', '1499757537');
INSERT INTO `dp_user_address` VALUES ('5', '1', '小青龙', '18899995547', '小龙潭小龙潭小龙潭小龙潭', '', '0', '1', '1499760879', '1499760879');
INSERT INTO `dp_user_address` VALUES ('6', '1', '大龙潭', '15924778888', '哈哈哈111', '', '0', '1', '1499760976', '1499760976');
