...
CREATE TABLE `dp_admin_attachment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='附件表';
...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$XYO0G./2.zPgYqsCPxf7b.bstQz3eluHHTiP13MKi0WUKNH6SNbMq', '', '0', '18888888888', '0', '1', '0.00', '0', '1', '0', '0', '1476065410', '1499736611', '1499736611', '2130706433', '100', '1');
...
-- Records of dp_cate
-- ----------------------------
INSERT INTO `dp_cate` VALUES ('1', '水果', '水果', '7', '100', '1', '1499405067', '0');
INSERT INTO `dp_cate` VALUES ('2', '服饰', '服饰', '13', '100', '1', '1499415242', '1499415242');
INSERT INTO `dp_cate` VALUES ('3', '生活用品', '生活用品', '16', '100', '1', '1499416087', '1499416087');
INSERT INTO `dp_cate` VALUES ('4', '饮品', '饮料', '0', '100', '1', '1499651461', '1499651461');
INSERT INTO `dp_cate` VALUES ('5', '速食', '泡面啊', '0', '100', '1', '1499651519', '1499651519');
...
CREATE TABLE `dp_product` (
  ...
  `group_days` int(11) NOT NULL DEFAULT '0' COMMENT '团购时长/天数',
...
-- ----------------------------
INSERT INTO `dp_product` VALUES ('1', '你的背包', '', '', '阿迪背包', '4', '3', '1,2,4', '24', '20', '9.00', '8.00', '7.00', '6.00', '5', '0', '0', '0', '0', '0', '0', '0', '0', '4', '0.00', '100', '1', '1499405003', '1499667621');
INSERT INTO `dp_product` VALUES ('2', '休闲外套', '', '', '统一老坛酸菜11', '5', '2', '3,4', '17', '4,8', '10.00', '9.00', '8.00', '7.00', '999', '0', '0', '0', '0', '0', '0', '0', '0', '100', '0.00', '100', '1', '1499416286', '1499666462');
INSERT INTO `dp_product` VALUES ('3', '新鲜水果', '', '', '新鲜水果批发', '2', '1', '4', '4', '8,4,3', '100.00', '90.00', '80.00', '60.00', '999', '0', '0', '0', '0', '0', '0', '0', '0', '100', '0.00', '100', '1', '1499652274', '1499664568');
INSERT INTO `dp_product` VALUES ('4', '统一老坛酸菜', '', '', '酸菜', '3', '5', '1,2,3,4,5', '22', '23', '5.00', '4.00', '3.00', '2.00', '111', '0', '0', '0', '0', '0', '0', '0', '0', '111', '0.00', '100', '1', '1499659336', '1499668373');
...
CREATE TABLE `dp_user` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态：0禁用，1启用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户/会员表';

-- ----------------------------
-- Records of dp_user
-- ----------------------------
INSERT INTO `dp_user` VALUES ('1', 'pp001', 'alipiapia', '$2y$10$9wVp0gAP.10E.41jUNbZgu/MUBMn5XwejQRXZCE2oFYVtISMCbsLK', '', '12@qq.com', '15924900001', '15924900000', '13888888888', '0.00', '0', '0', '1499400175', '1499740216', '1499740215', '2130706433', '100', '1');
